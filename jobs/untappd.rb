...
SCHEDULER.every '5m', :first_in => 0 do |job|
        ...
        if send_update_1 && send_update_2
                send_event('untappd', { untappd_uniquebeers: uniquebeers, untappd_badges: numbadges, untappd_latest_beer_label: latestlabel, untappd_latest_beer_name: latestname, untappd_latest_beer_myrating: latestrating, untappd_latest_beer_brewery: latestbrewery, untappd_latest_badge: latestbadge, untappd_latest_badge_image: latestbadgeimage })
        end
end
